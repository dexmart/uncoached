...
const AdminAffirmationCategoriesPage = () => {
    ...
    const fetchCategories = async () => {
        try {
            ...
            alert('Failed to load Affirmation Categories.');
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleDelete = async (id) => {
        if (!window.confirm('Are you sure you want to delete this category? All affirmations inside it will be permanently deleted.')) {
            return;
        }
...
export default AdminAffirmationCategoriesPage;

    ...
    return (
        <section className="whitespace-pre-line py-16 lg:py-24 relative overflow-hidden bg-bone" id="deeper-work">
            ...
            <div className="absolute inset-0 z-0 hidden lg:block">
                <img src={import.meta.env.BASE_URL + "bg/S3-deeper-work-v2.webp"} alt="" className="w-full h-full object-cover" />
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
                ...
                <img
                    src={import.meta.env.BASE_URL + "bg/S3-deeper-work-mobile.webp"}
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    {/* Right - Content */}
                    <div className="order-1 lg:order-2 lg:bg-bone/85 lg:backdrop-blur-md lg:rounded-3xl lg:p-8 xl:p-10 lg:border lg:border-white/50 lg:shadow-sm">
